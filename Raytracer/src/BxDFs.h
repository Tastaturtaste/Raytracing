...
namespace bxdf {
	...
	inline bxdfResult lambert(const std::array<norm3, 3>& basis, const Ray& in, const IntersectionTrace& trace, double u, double v) noexcept {
	...
	inline bxdfResult phong(const std::array<norm3, 3>& basis, const Ray& in, const IntersectionTrace& trace, double u, double v) noexcept {
